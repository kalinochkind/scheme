...
const std::string startup =
    ...
    "(define (with-input-from-port port thunk) (define old (current-input-port)) (set-current-input-port! port) "
    "  (define r (thunk)) (set-current-input-port! old) r) "
    "(define (with-output-to-port port thunk) (define old (current-output-port)) (set-current-output-port! port) "
    "  (define r (thunk)) (set-current-output-port! old) r) "
    "(define open-binary-input-file open-input-file) "
    "(define open-binary-output-file open-output-file) "
    "(define open-binary-i/o-file open-i/o-file) "
    "(define (call-with-input-file name p) (define f (open-input-file name)) (define r (p f)) (close-input-port f) r) "
    "(define (call-with-output-file name p) (define f (open-output-file name)) (define r (p f)) (close-output-port f) r) "
    "(define call-with-binary-input-file call-with-input-file) "
    "(define call-with-binary-output-file call-with-output-file) "
    "(define (with-input-from-file name t) (call-with-input-file name (lambda (p) (with-input-from-port p t)))) "
    "(define (with-output-to-file name t) (call-with-output-file name (lambda (p) (with-output-to-port p t)))) "
    "(define with-input-from-binary-file with-input-from-file) "
    "(define with-output-to-binary-file with-output-to-file) "
    "(define (with-input-from-string s t) (with-input-from-port (open-input-string s) t)) "

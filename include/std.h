...
extern std::unordered_map<std::string, std::shared_ptr<SchemeObject> (*)(const std::list<std::shared_ptr<ASTNode>> &,
                                                                         Context &context,
                                                                         std::shared_ptr<SchemeFunc> tail_func)> special_forms;

extern std::unordered_map<std::string, std::shared_ptr<SchemeObject> (*)(
